...
<main>
		...
		>
			...
			<div class="navbar-start">
				...
				<div class="hidden lg:flex">
					<a class="btn btn-ghost" href="/dataset">Dataset</a>
	...
	<!-- Footer -->
	<div
		class="flex flex-col md:flex-row justify-center md:justify-between items-center bg-neutral rounded-t-xl p-2"
	>
